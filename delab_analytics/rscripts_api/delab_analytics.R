...
function(texts = ""){
  ...
  if (intervention_thresh > out_inference$prob_intervention){
    ...
    if(Sys.getenv("INTERVENTION_THRESHOLD") == ""){
      out_llm <- str_c("The inferred intervention probability ", out_inference$prob_intervention,
    ...
    print(str_c("Finished llm response generation. The inferred intervention probability is ", out_inference$prob_intervention, "."))
  }
